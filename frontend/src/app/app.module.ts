...
import { CustomersComponent } from './Customer_Components/customers/customers.component';
...
@NgModule({
  declarations: [
    FooterComponent, AppComponent, NavComponent, HomeComponent, AboutUsComponent, ContactComponent, SignupComponent,
    LoginComponent, ForBusinessComponent, CategoryComponent, BusinessesComponent, TestimoniesComponent, BusinessComponent,
    CustomersComponent, ScheduleComponent,
    MediaComponent,

...
export class BusinessServiceService {
  ...
  getAllBusinesses(): businessServiceType[] {
    return this.businesses;
  }

  getBusinessesByCategory(category: string): businessServiceType[] {
    return this.businesses.filter(business => business.category === category);
  }
